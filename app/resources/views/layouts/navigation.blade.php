...
<div class="hidden sm:flex sm:items-center sm:ms-6">
    ...
    @else
        <!-- If no user is authenticated, display a login link or a message -->
        <span>Please log in to access settings.</span>
        <a href="{{ url('/') }}" class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal"  aria-current="page">Home</a>
    @endif
</div>
